...
with open(file_to_save, "w") as txt_file:
    ...
    election_results_string = (
        f"\nElection Results\n"
        f"-------------------------\n"
        f"Total Votes: {total_votes:,}\n"
        f"-------------------------\n\n"
        f"County Votes:\n")
    print(election_results_string, end="")

    txt_file.write(election_results_string)
    ...
    for county_name in county_votes:
        ...
        if (Cvotes > county_winning_count) and (county_vote_percentage > county_winning_percentage):
            county_winning_count = Cvotes
